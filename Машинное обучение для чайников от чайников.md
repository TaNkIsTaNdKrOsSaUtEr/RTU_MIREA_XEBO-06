...
Машинное обучение (ML) — это когда ты заставляешь компьютер угадывать ответы, дав косвенно связанные исходные данные. Главное — накормить его правильными данными и надеяться, что он не переобуется на ходу.
